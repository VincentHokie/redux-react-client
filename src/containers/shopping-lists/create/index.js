      ...
      <div className="input-wrap">
        ...
        <div className="col-xs-12">
          <div className="form-group">
            ...
            <input type="text" placeholder="Shopping List Name" name="name" className="form-control" required="required" autoFocus onChange={props.handleChange} value={props.name} disabled={props.loading ? "disabled" : false} />

          </div>
        </div>

        <div className="col-xs-12">
          <FormButton loading={props.loading} title="Create Shopping List" />
        </div>
